    ...
    <div v-else>
        <div v-if="!isEditing">
          <form @submit="validate" action="/http://localhost:8080/novo-contato"  method="post" novalidate="true" >
            ...
            <input type="text" class="form__input" placeholder="Nome: xxxxx" v-model="contatoNome" />
            <input
              type="radio"
            ...
            />
            Mulher<br />
            <input type="text" class="form__input" placeholder="Email: x@x.xx" v-model="contatoEmail" />
      ...
      <div v-else>
        ...
        <form @submit="validateUpdate" action="/http://localhost:8080/novo-contato"  method="post" novalidate="true" >
          ...
          <input type="text" class="form__input"   placeholder="Nome:" v-model="contatoNome" />
            <div v-if="contatoSexo === 'Masculino'" >
                <input
                  type="radio"
                  @change="onChange($event)"
                  class="inline"
